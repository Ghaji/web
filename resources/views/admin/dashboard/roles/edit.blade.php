                        ...
                        <div class="tabbable paper-shadow relative" data-z="0.5">
                            ...
                            <div class="tab-content">
                                ...
                                <div id="course" class="tab-pane active">
                                    ...
                                    {!! Form::model($role, ['method' => 'PATCH','route' => ['roles.update', $role->id],'class'=>'form-horizontal']) !!}
                                     {{ csrf_field() }}
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="description" id="description" cols="30" rows="10" class="summernote">{!! $role->description !!}</textarea>
                                        </div>
                                    ...
                                    <div class="text-left">
                                        <button type="submit" class="btn btn-primary"><i class="fa fa-user"></i> Update Roles</button>
                                    </div>
                                    {!! Form::close() !!}
                                </div>
                            </div>
