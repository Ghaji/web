                                    ...
                                    <form class="form-horizontal" method="POST" action="{{ route('pages.store') }}">
                                     {{ csrf_field() }}
                                                ...
                                                <div class="col-sm-9">
                                                    <select id="slug" name="slug" class="selectpicker" data-live-search="true">
                                                        ...
                                                        @foreach( $main_menus as $main_menu )
                                                            <option value="{{ $main_menu->slug }}">{{ ucfirst($main_menu->name) }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                        ...
                                        <div id="dropNo" style="display: none;">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9 form-control-material">
                                                    <input type="text" class="form-control" id="slug2" name="slug2" placeholder="Page Slug" value="{{ old('slug2') }}">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-control-material">
                                            <input type="text" name="owner" id="owner" placeholder="Page Owner" class="form-control" value="{{ old('owner') }}" />
                                        </div>    
                                        </div>
