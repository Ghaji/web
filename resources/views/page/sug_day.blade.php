...
@section('content')
     ...
     <div class="parallax overflow-hidden bg-blue-400 page-section bg-green-300">
        <div class="container parallax-layer" data-opacity="true">
            <div class="media v-middle">
                ...
                <div class="media-body">
                    <h1 class="text-white text-display-1 margin-v-0">{!! $title !!}</h1>
                ...
                <div class="col-md-8 col-lg-9">
                    <div class="page-section padding-top-none">
                        <div class="s-container">
                            <h1 class="text-display-1 margin-top-none">{!! $title !!}</h1>
