         ...
         <div class="st-content-inner padding-top-none">
                    <div class="container-fluid">
                        <div class="page-section">
                            <div class="media media-grid v-middle">
                                ...
                                <div class="media-body">
                                    <h3 class=" margin-none">List of News</h3>
                                </div>
                            </div>
                            <br/>
                        ...
                        <div class="panel panel-default curriculum paper-shadow" data-z="0.5">
                            <div class="panel-heading panel-heading-gray" data-toggle="collapse" data-target="#curriculum-{{ $new->id }}">
                                <div class="media">
                                    <div class="media-left">
                                    ...
                                    <div class="media-body">
                                        <h4 class="text-headline">
                                        	@if(strlen($new->title) >= 39)
                                                {{ substr($new->title, 0, 39).'...' }}
                                            @else
                                                {{ $new->title }}
                                            @endif
                                        </h4>
                                        <p>
                                        	<div class="text-light text-caption">
                                                Posted by
                                                <a href="#">
                                                    <i class="fa fa-institution"></i> {{$new->author}}</a> &nbsp; | <i class="fa fa-clock-o fa-fw"></i> {{ \Carbon\Carbon::createFromTimeStamp(strtotime($new->created_at))->diffForHumans() }}
                                            </div>
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div class="list-group collapse" id="curriculum-{{ $new->id }}">
                                <div class="list-group-item media" data-target="{{route('single.show', $new->slug)}}">
                                    <div class="media-left">
