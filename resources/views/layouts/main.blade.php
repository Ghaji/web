...
<head>
    ...
    <link href="{{ asset('../resources/assets/css/vendor.min.css') }}" rel="stylesheet">
...
To learn more about the development process, please refer to the documentation. -->
    <!-- <link href="{{ asset('../resources/assets/css/theme.bundle.min.css') }}" rel="stylesheet"> -->
    <!-- Compressed Theme CORE
This variant is to be used when loading the separate styling modules -->
    <link href="{{ asset('../resources/assets/css/theme-core.min.css') }}" rel="stylesheet">
    <!-- Standalone Modules
    As a convenience, we provide the entire UI framework broke down in separate modules
    Some of the standalone modules may have not been used with the current theme/module
    but ALL modules are 100% compatible -->
    <link href="{{ asset('../resources/assets/css/module-essentials.min.css') }}" rel="stylesheet" />
    <link href="{{ asset('../resources/assets/css/module-material.min.css') }}" rel="stylesheet" />
    <link href="{{ asset('../resources/assets/css/module-layout.min.css') }}" rel="stylesheet" />
    <link href="{{ asset('../resources/assets/css/module-sidebar.min.css') }}" rel="stylesheet" />
    <link href="{{ asset('../resources/assets/css/module-sidebar-skins.min.css') }}" rel="stylesheet" />
    <link href="{{ asset('../resources/assets/css/module-navbar.min.css') }}" rel="stylesheet" />
    <link href="{{ asset('../resources/assets/css/module-messages.min.css') }}" rel="stylesheet" />
    <link href="{{ asset('../resources/assets/css/module-carousel-slick.min.css') }}" rel="stylesheet" />
    <link href="{{ asset('../resources/assets/css/module-charts.min.css') }}" rel="stylesheet" />
    <link href="{{ asset('../resources/assets/css/module-maps.min.css') }}" rel="stylesheet" />
    <link href="{{ asset('../resources/assets/css/module-colors-alerts.min.css') }}" rel="stylesheet" />
    <link href="{{ asset('../resources/assets/css/module-colors-background.min.css') }}" rel="stylesheet" />
    <link href="{{ asset('../resources/assets/css/module-colors-buttons.min.css') }}" rel="stylesheet" />
    <link href="{{ asset('../resources/assets/css/module-colors-text.min.css') }}" rel="stylesheet" />
     <link href="{{ asset('../resources/assets/css/ticker-style.css') }}" rel="stylesheet" />
...
<body>
   ...
   <!--  <script src="{{ asset('../resources/assets/js/jquery-1.11.2.min.js') }}"></script> -->
    ...
    <script src="{{ asset('../resources/assets/js/vendor-core.min.js') }}"></script>
    <script src="{{ asset('../resources/assets/js/vendor-countdown.min.js') }}"></script>
    <script src="{{ asset('../resources/assets/js/vendor-tables.min.js') }}"></script>
    <script src="{{ asset('../resources/assets/js/vendor-forms.min.js') }}"></script>
    <script src="{{ asset('../resources/assets/js/vendor-carousel-slick.min.js') }}"></script>
    <script src="{{ asset('../resources/assets/js/vendor-player.min.js') }}"></script>
    <script src="{{ asset('../resources/assets/js/vendor-charts-flot.min.js') }}"></script>
    <script src="{{ asset('../resources/assets/js/vendor-nestable.min.js') }}"></script>
    <!-- <script src="{{ asset('../resources/assets/js/vendor-angular.min.js') }}"></script> -->
    <!-- Compressed Vendor Scripts Bundle
    Includes all of the 3rd party JavaScript libraries above.
    The bundle was generated using modern frontend development tools that are provided with the package
    To learn more about the development process, please refer to the documentation.
    Do not use it simultaneously with the separate bundles above. -->
    <!-- <script src="{{ asset('../resources/assets/js/vendor-bundle-all.min.js') }}"></script> -->
    <!-- Compressed App Scripts Bundle
    Includes Custom Application JavaScript used for the current theme/module;
    Do not use it simultaneously with the standalone modules below. -->
    <!-- <script src="{{ asset('../resources/assets/js/module-bundle-main.min.js') }}"></script> -->
    <!-- Standalone Modules
    As a convenience, we provide the entire UI framework broke down in separate modules
    Some of the standalone modules may have not been used with the current theme/module
    but ALL the modules are 100% compatible -->
    <script src="{{ asset('../resources/assets/js/module-essentials.min.js') }}"></script>
    <script src="{{ asset('../resources/assets/js/module-material.min.js') }}"></script>
    <script src="{{ asset('../resources/assets/js/module-layout.min.js') }}"></script>
    <script src="{{ asset('../resources/assets/js/module-sidebar.min.js') }}"></script>
    <script src="{{ asset('../resources/assets/js/module-carousel-slick.min.js') }}"></script>
    <script src="{{ asset('../resources/assets/js/module-player.min.js') }}"></script>
    <script src="{{ asset('../resources/assets/js/module-messages.min.js') }}"></script>
    <!-- <script src="{{ asset('../resources/assets/js/module-maps-google.min.js') }}"></script> -->
    <script src="{{ asset('../resources/assets/js/module-charts-flot.min.js') }}"></script>
    <!-- [html] Core Theme Script:
        Includes the custom JavaScript for this theme/module;
        The file has to be loaded in addition to the UI modules above;
        module-bundle-main.js already includes theme-core.js so this should be loaded
        ONLY when using the standalone modules; -->
    <script src="{{ asset('../resources/assets/js/theme-core.min.js') }}"></script>

    <!-- <script src="{{ asset('../resources/assets/js/jquery-1.11.2.min.js') }}"></script> -->
    <script src="{{ asset('../resources/assets/js/jquery-1.6.2.min.js') }}"></script>
    <script src="{{ asset('../resources/assets/js/jquery.ticker.js') }}" type="text/javascript"></script>
    <script src="{{ asset('../resources/assets/js/jquery-easing.js') }}"></script>
    <script src="{{ asset('../resources/assets/js/jquery_ticker.js') }}"></script>
    <!-- <script src="{/{ asset('../resources/assets/js/jquery.easy-ticker.js') }}"></script> -->
    ...
    <!-- <script src="{/{ asset('../resources/assets/js/jquery-easing.js') }}"></script> -->
    <!-- <script src="{{ asset('../resources/assets/js/jquery.easy-ticker.js') }}" type="text/javascript"></script> -->
    <script type="text/javascript">
    $(document).ready(function(){
        // $('#js-news').ticker();
    ...
    <!-- <script src="{{ asset('../resources/assets/js/bootstrap.newsbox.min.js') }}" type="text/javascript"></script>  -->
    <!-- <script type="text/javascript">
        $(document).ready(function(){

            $(".vticker").bootstrapNews({
                newsPerPage: 3,
                autoplay: true,
                pauseOnHover:true,
                direction: 'up',
